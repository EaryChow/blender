  ...
  builder.construct_and_set_matching_fn_cb([&]() {
    return mf::build::detail::build_multi_function_with_n_inputs_one_output<float4>(
      ...
      [=, &builder](const float4 &color,
         ...
         const mf::build::optional_input<float> log2_min_in,
         const mf::build::optional_input<float> log2_max_in,
         const float3 hue_flights_in,
         const float3 attenuation_rates_in,
         const mf::build::optional_input<float3> reverse_hue_flights_in,
         const mf::build::optional_input<float3> restore_purity_in,
        ...
        return agx_image_formation(
            ...
            (builder.node().custom1) ? make_float3(0, 0, 0) : reverse_hue_flights_in.value_or(make_float3(0, 0, 0)),
            (builder.node().custom1) ? make_float3(0, 0, 0) : restore_purity_in.value_or(make_float3(0, 0, 0)),
      ...
      TypeSequence<float4,
                   ...
                   float,
                   float,
                   mf::build::optional_input<float>,
                   mf::build::optional_input<float>,
                   float3,
                   float3,
                   mf::build::optional_input<float3>,
                   mf::build::optional_input<float3>,
                   float,
                   float,
                   float,
